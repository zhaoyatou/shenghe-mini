<template>
	<view class="submitpage">
		...
		<view class="text-box">
			<u--text bold block margin="80rpx auto 40rpx" align="left" size="30rpx" :text="'合同编号:' + ' ' + optionData.contractNo"></u--text>
			<u--text bold block margin="40rpx auto 80rpx" align="left" size="30rpx" :text="'提交时间:'+ ' ' + timeString(optionData.updateTime)"></u--text>
			<u--text bold block margin="80rpx auto 40rpx" align="left" size="30rpx" text="延保订单提交成功"></u--text>
			<u--text bold block margin="40rpx auto 100rpx" align="left" size="30rpx" text="请等待审核人员对信息进行审核"></u--text>
		</view>
		<view class="button-box">
			<u-button type="primary" @click="tolistpage" text="返回列表"></u-button>
		</view>
